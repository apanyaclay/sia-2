...
@section('container')
    <div class="edit text-sm-end"><a type="button" class="btn btn-secondary mt-3 mb-3" href="{{ url('admin/listkelassiswa/tambah') }}"><i
        ...
        <table  class="table text-center table-bordered  mt-4"style="width:900px ;" >
            ...
            <tbody >
             ...
             <tr>
               ...
               <td><a type="button"  href="{{url('admin/listsiswa', $item->id)}}"  class="btn btn-warning">Lihat Jadwal</a></td>
               <td><a type="button" href="{{ url('admin/listkelassiswa/edit', $item->id) }}" class="btn btn-warning"><i
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#hapusButton').click(function() {
                var ekskulId = $(this).data('ekskulid');
                window.location.href = '/admin/listkelassiswa/delete/' + ekskulId;
            });
        });
    </script>
@endsection
