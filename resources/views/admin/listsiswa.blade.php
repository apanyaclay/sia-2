...
@section('container')
    <div class="edit text-sm-end"><a href="{{ url('admin/listsiswa/tambah', $kode) }}" type="button"
            ...
            <tbody>
                @for ($i = 0; $i < count($siswa); $i++)
                    <tr>
                        ...
                        <td><a type="button" href="{{ url('/admin/listsiswa/detail', $siswa[$i]->nisn) }}"
                                class="btn btn-warning">Lihat Detail</a></td>
                        <td><a type="button" href="{{ url('admin/listsiswa/edit', $siswa[$i]->nisn) }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#hapusButton').click(function() {
                var ekskulId = $(this).data('ekskulid');
                window.location.href = '/admin/listsiswa/delete/' + ekskulId;
            });
        });
    </script>
@endsection
