...
@section('container')
    <div class="edit text-sm-end"><a href="{{ url('admin/listguru/tambah') }}" type="button"
            ...
            <tbody>
                <tr>
                    @foreach ($data as $item)
                        ...
                        <td><a type="button" href="{{ url('admin/listguru/detail', $item->nuptk) }}"
                                class="btn btn-warning">Lihat Detail</a></td>
                        <td><a type="button" href="{{ url('admin/listguru/edit', $item->nuptk) }}" class="btn btn-warning"><i
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#hapusButton').click(function() {
                var ekskulId = $(this).data('ekskulid');
                window.location.href = '/admin/listguru/delete/' + ekskulId;
            });
        });
    </script>
@endsection
