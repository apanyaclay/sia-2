...
@section('container')
    <!-- Page Heading -->
    <div class="edit text-sm-end"><a href="{{ url('admin/listekskul/tambah') }}" type="button"
            ...
            <tbody>
                <tr>
                    @foreach ($data as $ekskul)
                        ...
                        <td><a type="button" href="{{ url('admin/listekskul/edit', $ekskul->id) }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#hapusButton').click(function() {
                var ekskulId = $(this).data('ekskulid');
                window.location.href = '/admin/listekskul/delete/' + ekskulId;
            });
        });
    </script>
@endsection
