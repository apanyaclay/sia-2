...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #748E63;">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('siswa')}}">
...
<br>
            ...
            <!-- Jadwal -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url('siswa/jadwalmapel')}}"  data-target="#collapseTwo"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="	fa fa-calendar" style="color: #ffc527;"></i>
                    <span>J  A D W A L</span>
                </a>
            </li>
            ...
            <!-- Rapor-->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url('siswa/rapor')}}"  data-target="#collapseUtilities"
            ...
            <!-- Profile -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url('siswa/profile')}}"  data-target="#collapsePages"
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{ url('siswa/profile')}}">
