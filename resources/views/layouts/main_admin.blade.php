...
<br>
            ...
            <hr class="sidebar-divider">
             ...
             <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities"
                    ...
                    <i class="fa-solid fa-list-check" style="color: #ffc527;"></i>                    <span>Manajemen User</span>
                </a>
            ...
            <!-- Nilai -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{url('admin/listkelasnilai')}}"  data-target="#collapseTwo"
             ...
             <!-- Jadwal -->
             <li class="nav-item">
                <a class="nav-link collapsed" href="{{url('admin/listkelas')}}"  data-target="#collapseTwo"
                     aria-expanded="true" aria-controls="collapseTwo">
           ...
           <li class="nav-item">
            ...
            <div id="collapseUtilities2" class="collapse" aria-labelledby="headingUtilities"
                data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{url('admin/listekskul')}}">Daftar Ekstrakurikuler</a>
                    <a class="collapse-item" href="{{url('admin/listekskulsiswa')}}">Ekstrakurikuler Siswa</a>
                </div>
            </div>
             ...
             <!-- Profile -->
             <li class="nav-item">
                 <a class="nav-link collapsed" href="{{url('admin/audit')}}"  data-target="#collapsePages"
            ...
            <!-- Profile -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{url('admin/profile')}}"  data-target="#collapsePages"
                    aria-expanded="true" aria-controls="collapsePages">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Tata Usaha</span>
