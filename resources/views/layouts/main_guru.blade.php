...
<br>
            ...
            <!-- Jadwal -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{url('guru/jadwalmengajar')}}"  data-target="#collapseTwo"
            ...
            @if ($guru = DB::select('SELECT * FROM gurus WHERE user_id = ?', [Auth::user()->id]))
            @if ($guru[0]->jenis_ptk == 'Guru Wali Kelas')
                <!-- Pembatas -->
                <hr class="sidebar-divider">
                <!-- Rapor-->
                <li class="nav-item">
                    <a class="nav-link collapsed" href="{{url('guru/rapor')}}"  data-target="#collapseUtilities"
            ...
            <!-- Nilai -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{url('guru/listkelas')}}"  data-target="#collapseTwo"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fa fa-address-book" style="color: #ffc527;"></i>
            ...
            <!-- Profile -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{url('guru/profile')}}"  data-target="#collapsePages"
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="Profile_lengkap_guru.html">
