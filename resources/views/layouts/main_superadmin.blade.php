...
<body id="page-top">
 ...
 <br>
         ...
         <li class="nav-item active">
             <a class="nav-link" href="{{ route('kepsek')}}">
          ...
          <li class="nav-item">
             ...
             <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                 ...
                 <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{ url('superadmin/daftarkelassiswasadmin')}}">SISWA</a>
                    <a class="collapse-item" href="{{ url('superadmin/daftarptksadmin')}}">PTK</a>
                    <a class="collapse-item" href="{{ url('superadmin/daftartusadmin')}}">Tata Usaha</a>
                 </div>
             </div>
         </li>
         ...
         <!-- Rapor Siswa -->
         <li class="nav-item">
             <a class="nav-link collapsed" href="{{ url('superadmin/listraporsiswasadmin')}}"  data-target="#collapseTwo"
          ...
          <!-- Daftar MaPel -->
          <li class="nav-item">
              <a class="nav-link collapsed" href="{{ url('superadmin/daftarkelasMP')}}"  data-target="#collapsePages"
         ...
         <!-- Jadwal  Siswa-->
         <li class="nav-item">
             <a class="nav-link collapsed" href="{{ url('superadmin/daftarkelasJS')}}"  data-target="#collapseTwo"
                 aria-expanded="true" aria-controls="collapseTwo">
          ...
          <!-- Validate-->
          <li class="nav-item">
              <a class="nav-link collapsed" href="{{ url('superadmin/daftarkelasVR')}}"  data-target="#collapsePages"
                  aria-expanded="true" aria-controls="collapsePages">
            ...
            <li class="nav-item">
             ...
             <div id="collapseUtilities1" class="collapse" aria-labelledby="headingUtilities"
                 data-parent="#accordionSidebar">
                 <div class="bg-white py-2 collapse-inner rounded">
                     <a class="collapse-item" href="{{ url('superadmin/daftarekskulsadmin')}}">Daftar Ekstrakurikuler</a>
                     <a class="collapse-item" href="{{ url('superadmin/daftarekskulsiswasadmin')}}">Ekstrakurikuler Siswa</a>
                 </div>
             </div>
         </li>
          ...
          <!-- Audit -->
          <li class="nav-item">
              <a class="nav-link collapsed" href="{{ url('superadmin/auditsadmin')}}"  data-target="#collapsePages"
                  aria-expanded="true" aria-controls="collapsePages">
         ...
         <!-- Setting -->
         <li class="nav-item">
             <a class="nav-link collapsed" href="{{ url('superadmin/settings')}}"  data-target="#collapsePages"
                 aria-expanded="true" aria-controls="collapsePages">
         ...
         <!-- Profile -->
         <li class="nav-item">
             <a class="nav-link collapsed" href="{{ url('superadmin/profilesadmin')}}"  data-target="#collapsePages"
                 aria-expanded="true" aria-controls="collapsePages">
                     ...
                     <li class="nav-item dropdown no-arrow d-sm-none">
                         ...
                         <li class="nav-item dropdown no-arrow">
                             ...
                             <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                 ...
                                 <a class="dropdown-item" href="{{ url('superadmin/profilesadmin')}}">
