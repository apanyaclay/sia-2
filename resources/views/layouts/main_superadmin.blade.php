    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #748E63;">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
                <div class="sidebar-brand-text mx-3"><img class="logo3 mt-5" src="{{ asset('assets/img/logo.png') }}"
                        height="80" width="90" alt=""> </div>
            </a>
            <br>
            <!-- Nav Item - Dashboard -->
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ url('superadmin/listkelassiswa') }}">SISWA</a>
                        <a class="collapse-item" href="{{ url('superadmin/listguru') }}">PTK</a>
                        <a class="collapse-item" href="{{ url('superadmin/listtu') }}">Tata Usaha</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Rapor Siswa -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url('superadmin/listkelasnilai') }}"
            ...
            <!-- Daftar MaPel -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url('superadmin/mapel') }}" data-target="#collapsePages"
            ...
            <!-- Jadwal  Siswa-->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url('superadmin/listkelas') }}" data-target="#collapseTwo"
            ...
            <!-- Validate-->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url('superadmin/rapor') }}" data-target="#collapsePages"
                    aria-expanded="true" aria-controls="collapsePages">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities1" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ url('superadmin/listekskul') }}">Daftar
                            Ekstrakurikuler</a>
                        <a class="collapse-item"
                            href="{{ url('superadmin/listekskulsiswa') }}">Ekstrakurikuler Siswa</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Audit -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url('superadmin/audit') }}"
            ...
            <!-- Profile -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url('superadmin/profile') }}"
                    data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="flex-center mt-5">
                                <a href="https://www.instagram.com/smpsamalyatulhuda/"><i
                                        class="fa fa-twitter fa-2x icon-3d"></i></a>
                                <a href="https://www.instagram.com/smpsamalyatulhuda/"><i
                                        class="fa fa-facebook fa-2x icon-3d"></i></a>
                                <a href="https://www.instagram.com/smpsamalyatulhuda/"><i
                                        class="fa fa-instagram fa-2x icon-3d"></i></a>
                                <a href="https://www.instagram.com/smpsamalyatulhuda/"><i
                                        class="fa fa-whatsapp fa-2x icon-3d"></i></a>
                            </div>
                        </div>
                        <!-- <div class="col-4">
