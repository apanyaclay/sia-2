...
@section('container')
    ...
    <div class="informasi py-3 px-5">
        <form action="{{ url('superadmin/listtu/edit') }}" method="POST">
            @csrf
            <table class="table mt-4">
                <div class="form-group">
                    <tr>
                        <th><label for="id">ID Pegawai:</label></th>
                        <td><input type="text" id="id" name="id" required value="{{ $data->id_pegawai }}"></td>
                    </tr>
                </div>
                <div class="form-group">
                    <tr>
                        <th><label for="nama">Nama:</label></th>
                        <td><input type="text" id="nama" name="nama" required value="{{ $data->nama_pegawai }}">
                        </td>
                    </tr>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <tr>
                        <th><label for="tmt_kerja">TMT Kerja:</label></th>
                        <td><input type="date" id="tmt_kerja" name="tmt_kerja" required value="{{ $data->tmt_kerja }}"></td>
                    </tr>
                </div>
                <div class="form-group">
                    <tr>
