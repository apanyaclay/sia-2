...
@section('container')
    <div class="edit text-sm-end"><a type="button" class="btn btn-secondary mt-3 mb-3" href="{{ url('superadmin/listkelassiswa/tambah') }}"><i
        ...
        <table  class="table text-center table-bordered  mt-4"style="width:900px ;" >
            ...
            <tbody >
             ...
             <tr>
               ...
               <td><a type="button"  href="{{url('superadmin/listsiswa', $item->id)}}"  class="btn btn-warning">Lihat Jadwal</a></td>
               <td><a type="button" href="{{ url('superadmin/listkelassiswa/edit', $item->id) }}" class="btn btn-warning"><i
                class="fa-solid fa-file-pen" style="color: #ffffff;"></i></a>
        <a type="button" href="" class="btn btn-warning" data-bs-toggle="modal"
            data-bs-target="#exampleModal" data-ekskulid="{{ $item->id }}"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Hapus Daftar Kelas</h1>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#hapusButton').click(function() {
                var ekskulId = $(this).data('ekskulid');
                window.location.href = '/superadmin/listkelassiswa/delete/' + ekskulId;
            });
        });
    </script>
@endsection
