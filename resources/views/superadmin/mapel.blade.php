...
@section('container')
    <div class="edit text-sm-end"><a type="button" class="btn btn-secondary mt-3 mb-3"
            href="{{ url('superadmin/mapel/tambah') }}"><i class="fa-solid fa-file-pen" style="color: #ffffff;"></i> Tambah
            Mata Pelajaran</a></div>
            ...
            <tbody>
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td><a type="button" href="{{ url('superadmin/mapel/edit', $item->id) }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#hapusButton').click(function() {
                var ekskulId = $(this).data('ekskulid');
                window.location.href = '/superadmin/mapel/delete/' + ekskulId;
            });
        });
    </script>
@endsection
