...
class SiswaController extends Controller
{
    public function index(){
        $data = Kelas::all();
        return view('admin.listkelassiswa', compact('data'));
    }

    public function tambahkelas(){
        $data = Guru::all();
        return view('admin.listkelassiswa-tambah', compact('data'));
    }
    ...
    public function tambahkelasPost(Request $request){
        ...
        if ($data) {
            ...
            return redirect('/admin/listkelassiswa');
        } else {
    ...
    public function editkelas($kode){
        ...
        return view('admin.listkelassiswa-edit', compact('data', 'kode', 'kelas'));
    }
    ...
    public function listsiswa($kode){
        ...
        $kelas = Kelas::find($kode);
        return view('admin.listsiswa', compact('siswa', 'kode', 'kelas'));
    }

    public function detailsiswa($kode){
        $data = Siswa::where('nisn', $kode)->first();
        return view('admin.listsiswa-detail', compact('data'));
    }

    public function tambahsiswa($kode){
        return view('admin.listsiswa-tambah', compact('kode'));
    }
    ...
    public function editsiswa($kode){
        $data = Siswa::where('nisn', $kode)->first();
        return view('admin.listsiswa-edit', compact('data'));
    }
