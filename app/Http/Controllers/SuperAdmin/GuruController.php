...
class GuruController extends Controller
{
    public function index(){
        $data = Guru::all();
        return view('superadmin.listguru', compact('data'));
    }

    public function detail($kode){
        $data = Guru::where('nuptk', $kode)->first();
        return view('superadmin.listguru-detail', compact('data'));
    }

    public function tambah(){
        return view('superadmin.listguru-tambah');
    }
    ...
    public function tambahPost(Request $request){
        ...
        if ($data) {
            try {
                ...
                DB::commit();
                return redirect('/superadmin/listguru');
            } catch (\Exception $e) {
                DB::rollback();
    ...
    public function edit($kode){
        $data = Guru::where('nuptk', $kode)->first();
        return view('superadmin.listguru-edit', compact('data'));
    }
