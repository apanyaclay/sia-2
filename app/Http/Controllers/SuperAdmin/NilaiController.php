...
class NilaiController extends Controller
{
    public function index(){
        $data = Kelas::all();
        return view('superadmin.listkelas-nilai', compact('data'));
    }

    public function listsiswa($kode){
        $kelas = Kelas::where('id', $kode)->first();
        $data = Siswa::where('kelas_id', $kode)->get();
        return view('superadmin.listnilaisiswa',compact('data', 'kelas'));
    }
    ...
    public function detail($kode){
        ...
        $data = DB::table('nilais')
            ...
            ->get();
        return view('superadmin.listnilaisiswa-detail', compact('data', 'siswa'));
    }

    public function editnilai($kode) {
        $nilai = Nilai::where('id', $kode)->first();

        return view('superadmin.editnilai', compact('kode', 'nilai'));
    }
    ...
    public function editnilaiPost(Request $request) {
        ...
        if ($data) {
            ...
            return redirect('/superadmin/listkelasnilai');
        } else {
